...
public class FollowCameraMultiplayer : MonoBehaviour {
    ...
    private void Start() {
        target = FindObjectOfType<MultiplayerController>().transform;
        targetBody = FindObjectOfType<MultiplayerController>().GetBody();
